...
description: 为 IT 专业人士提供有关 2016 年 Office 365 专业增强版每月频道发布的发行说明
ms.openlocfilehash: 9d51cecc870d48f0e6659dde1c6714d2c49c0e43
ms.sourcegitcommit: 04f3aa30703f4f1cf89721853a7c052fcca2b97f
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/24/2021
ms.locfileid: "51169871"
---
# <a name="release-notes-for-monthly-channel-releases-in-2016"></a>2016 年每月频道发布的发行说明

这些发行说明提供有关 2016 年 Office 365 专业增强版每月频道更新中包含的新功能、安全更新和非安全更新的信息。
...
-   **共同创作时进行实时键入：** 查看其他人在演示文稿中的工作位置，并查看键入的更改。 [详细信息](https://support.office.com/article/0c30ee3f-8674-4f0e-97be-89cf2892a34d)
...
-   修复了以下问题：在打开某些 XML 文件时，由于作业存在问题，无法正确设置任务开始日期。
...
-   修复了 Configuration Manager 切换的更新将注册表中的 UpdateChannel 设置更改为无效更新通道的问题。
...
### <a name="outlook-feature-updates"></a>Outlook：功能更新
-   **\@ 提及：** 将 @ 符号后跟人员姓名后跟电子邮件或日历项目正文，确保收件人知道他们需要输入或操作。 同时，这也会将他们自动添加到“收件人”行。 [详细信息](https://support.office.com/article/90701709-5dc1-41c7-aa48-b01d4a46e8c7)
...
### <a name="skype-for-business-non-security-updates"></a>Skype for Business：非安全更新
-   修复了在使用具有不同分辨率，尤其是高分辨率的显示器时，Skype for Business 不会随着显示器的更改而更新比例的问题。
...
-   修复了共享资源文件使用 RDP 的第三方实现且共享资源文件的分辨率低于查看器的分辨率时，如果查看器最大化 Skype 窗口，Skype for Business 崩溃的问题。
...
### <a name="office-suite-non-security-updates"></a>Office 套件：非安全更新
-   修复了执行联机修复时安装用户界面 (UI) 不显示的问题。
-   修复了即使对联机模板的访问权限已通过组策略设置或注册表设置禁用，“搜索联机模板”框仍然启用的问题。
...
### <a name="office-suite-non-security-updates"></a>Office 套件：非安全更新
-   解决了打开 Office 应用时，用户收到错误消息“Microsoft 无法找到应用程序的许可证，且修复尝试已失败或取消”，然后 Office 应用关闭的问题。
...
-   修复了复制或移动信息导致出现错误消息（如“无法打开剪贴板”或“无法释放剪贴板空间。其他程序可能正在使用它”）的问题。
...
### <a name="office-suite-feature-updates"></a>Office 套件：功能更新
-   **提供反馈：** 建议新的功能，或者转到“文件”\>“反馈”，告诉 Microsoft 你喜欢的功能或无法使用的功能。
-   **帮助改进：** 借助改进的搜索、内容和建议，在“告诉我”框中键入问题，并在应用中查找答案。
...
### <a name="skype-for-business-non-security-updates"></a>Skype for Business：非安全更新
-   修复以下问题：当用户使用与主持会议的组织无关联的帐户加入会议时，用户看到一个空白对话窗口的问题。
...
### <a name="powerpoint-feature-updates"></a>PowerPoint：功能更新
-   **SmartArt 图形共同创作：** 多个用户可以同时编辑 SmartArt 图形中的不同元素。
...
### <a name="excel-feature-updates"></a>Excel：功能更新
-   **发布到 Power BI：** 保存工作簿项目（例如图表、范围和表）并将其发布到 powerbi.com，并且与仪表板格式的该数据进行交互。需要 Power BI 订阅。 [详细信息](https://support.office.com/article/7342b49c-6567-4155-a7ac-acdc14d9ad0f)
...
-   修复了用户无法访问托管在 Exchange Server 2010 上的公用文件夹的问题。
...
-   **改进的公式自动完成：** 键入函数名称时，Excel 现在会返回所有部分匹配，而不只是从字符串开始的完全匹配。
...
### <a name="word-non-security-updates"></a>Word：非安全更新
-   修复了编辑文档时 Word 显示文档格式不正确的问题。 [有关此问题的详细信息](https://answers.microsoft.com/office/forum/office_2016-word/word-2016-doesnt-display-your-document-formatting/b7bb4017-8ae5-41ab-881b-03199d24ba83)
