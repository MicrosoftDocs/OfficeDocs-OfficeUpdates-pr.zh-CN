...
*版本 1711 （构建 8730.2122）*

### <a name="excel-feature-updates"></a>Excel：功能更新
-   **快速访问网站和组：** 使用“文件”菜单处理常用网站和组中存储的文档。

### <a name="powerpoint-feature-updates"></a>PowerPoint：功能更新
-   **导出为 4K：** 将演示文稿导出为视频时，可选择 Ultra HD (4K) 分辨率。
...
-   **字符数：** 在输入过程中，可以在状态栏上看到字符数。可以通过“自定义状态栏”菜单启用此功能。
-   **快速访问网站和组：** 使用“文件”菜单处理常用网站和组中存储的文档。
...
*版本 1710 （构建 8625.2132）*

### <a name="access-non-security-updates"></a>Access：非安全更新
-   修复了以下问题：打开 Access 运行时应用程序 (.accde file) 出现“无法识别此数据库的格式”错误消息且应用程序无法打开。

### <a name="excel-non-security-updates"></a>Excel：非安全更新
-   修复了以下问题：当用户尝试在现有的工作簿中插入对象时，用户单击“浏览”导致 Excel 发生故障的问题。
-   修复了以下问题：在使用密码保护区域时，输入密码以解锁区域的对话框不可见。
...
-   **创建网站的线框图表：** 快速创建网站的线框图表，其中包含界面、导航及其协作方式。 [更多信息](https://support.office.com/article/2d54dc55-f5c4-49a2-85da-d649eb7fc281)
-   **创建移动应用程序的线框：** 使用模板创建移动应用程序的线框。 [详细信息](https://support.office.com/article/2d54dc55-f5c4-49a2-85da-d649eb7fc281)
...
*版本 1709 （构建 8528.2139）*

### <a name="powerpoint-feature-updates"></a>PowerPoint：功能更新
-   **使用数控笔执行幻灯片放映：** 使用 Surface 触控笔或其他带有蓝牙按钮的触笔切换幻灯片。需要安装 Windows 10 Fall Creators Update。 [更多信息](https://support.office.com/article/e36da834-7d34-4b71-aafd-071727549f7a)
...
### <a name="visio-feature-updates"></a>Visio：功能更新
-   **将数据图形应用到数据可视化工具图表：** 通过自动将形状数据应用为数据图形，从而在创建数据可视化工具图表时节省时间。 [更多信息](https://support.office.com/article/17211b46-d144-4ca2-9ea7-b0f48f0ae0a6?#apply_dg)
-   **与人协作绘图：** 通过在 OneDrive for Business 或 SharePoint Online 上共享绘图，可以与人协作绘图。可以查看谁正在处理绘图，也可以添加注释和查看文件活动。 [详细信息](https://support.office.com/article/413c0b5a-0d52-4ace-af85-8b9bf115bbbf)
...
*版本 1707 （构建 8326.2073）*

### <a name="excel-non-security-updates"></a>Excel：非安全更新
-   修复了使用 SQL Server Analysis Services 服务器中的数据，且 Excel 与 SQL Server Analysis Services 服务器的区域设置不同时，数据刷新无法成功或 Excel 发生故障的问题。



## <a name="version-1707-august-7"></a>版本 1707年： 年 8 月 7
*版本 1707 （构建 8326.2070）*
...
### <a name="word-feature-updates"></a>Word：功能更新
-   **使用学习工具进行编辑：** 学习工具现适用于 Word 的 Web 布局。编辑时，可以调整文字间距，并显示音节。在任意视图中，大声朗读文档时，每个单词都会突出显示。 [更多信息](https://support.office.com/article/a857949f-c91e-4c97-977c-a4efcaf9b3c1)
-   **LaTeX 语法：** 使用 LaTeX 语法创建和编辑数学公式。
-   **实用的语音提示改进了辅助功能：** 打开音频提示后，可指导用户完成工作。可以在“文件”\>“选项”\>“辅助功能”中找到此功能。不需要加载项。 [更多信息](https://support.office.com/article/49fda9be-cce5-4c72-a87f-b11000197f5f)
-   **按帐户组织的文件位置：** 在打开或保存文件时，按与位置关联的帐户来组织位置列表。

### <a name="office-suite-non-security-updates"></a>Office 套件：非安全更新
-   添加对 mscomctl.ocx 的 64 位支持，允许用户使用 64 位版本的 Office 进行创建、编辑，以及打开包含公共控件的宏文件。
-   改进 mscomctl.ocx 中所使用控件的辅助功能。



## <a name="version-1706-july-19"></a>版本 1706年： 年 7 月 19
*版本 1706 （构建 8229.2103）*
...
*版本 1705 （构建 8201.2075）*

### <a name="excel-feature-updates"></a>Excel：功能更新
-   **保留副本**：在复制单元格后以及粘贴单元格前，仍可以执行其他任务，如键入内容或插入单元格。
...
### <a name="project-non-security-updates"></a>Project：非安全更新
-   修复了由于单个形状不工作而要将日程表复制到 PowerPoint 的问题。
...
### <a name="powerpoint-feature-updates"></a>PowerPoint：功能更新
-   **QuickStarter：** 自动生成大纲，帮助用户开始研究他们所选的主题。 [详细信息](https://support.office.com/article/4784f273-0b2c-456c-9c89-24e5b977c224)
-   **共享文件活动：** 选择文件右上角的“活动”按钮，可以查看在 OneDrive for Business 或 SharePoint 中共享的文经共享、编辑、重命名或恢复的时间。
...
### <a name="powerpoint-feature-updates"></a>PowerPoint：功能更新
-   **数字标尺：** 在具有触摸屏的设备上，转到“绘图”\>“标尺”，然后使用笔或手指绘制直线或对齐一组对象。 [详细信息](https://support.office.com/article/6222c9b4-2fdf-48f7-a3fd-1687fbe2bf84)
-   **背景消除：** 使用任意格式的绘图工具删除图片背景。
...
-   修复了在将鼠标悬停在白板注释上时，不显示创建者和修改者名称的问题。
...
### <a name="powerpoint-non-security-updates"></a>PowerPoint：非安全更新
-   修复了以下问题：在幻灯片模式下，当“讲述人”正在运行时，如果用户单击超链接，PowerPoint 会发生故障，且网站加载缓慢。
