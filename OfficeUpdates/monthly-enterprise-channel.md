...
## <a name="version-2104-june-08"></a>版本 2104：6 月 8 日
...
- 修复了某些用户的 Excel 加载项列表中出现额外条目这一问题。


- 修复了某个主要版本内部版本回滚可能导致应用程序在文件打开时终止这一问题。
...
- 我们修复了导致漫游设置的用户遭遇无响应的问题。


- 我们修复了导致用户在搜索时遭遇进程意外终止的问题。


- 我们修复了搜索相关的意外关闭问题。


- 我们修复了对于拥有永久许可的用户导致 Outlook 中的人员选取器向上扩展而不是向下扩展的问题。


### <a name="powerpoint"></a>PowerPoint

- 修复了部分用户无法使用“重用幻灯片”选项的问题。


- 我们修复了与链接图片相关的问题。


- 修复了某个主要版本内部版本回滚可能导致文件打开时意外关闭这一问题。
...
- 我们修复了需要对编辑 OLE 对象进行更改的问题。


- 我们修复了在阅读模式下使用深色模式主题时某些选定文本不可见这一问题。


- 修复了因用户日志记录关闭或重启计算机导致关机时 Word 意外关闭的问题。


- 我们修复了更新本地保存文件的自动保存标注文本的问题。
...
- 修复了在回滚到以前的内部版本后 Word、PowerPoint 和 Excel 无法打开云文档这一问题
...
- 修复了具有 ARM 处理器的计算机上，启用 MAPI 的应用程序所使用的 Outlook 组件中的问题。 该问题可能导致搜索失败，或者由于后台应用反复重启而导致电脑产生额外负载。
...
[//]: # (不修改管理中心元数据内容启动)
[//]: # (|Win32|MEC|生产|功能|16.0.13929.20408|version-2104-june-08|)
