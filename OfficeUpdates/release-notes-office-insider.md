...
### <a name="find-what-youre-looking-for-with-microsoft-search"></a>使用 Microsoft Search 查找你要查找的内容

通过 Microsoft Search, 您可以找到完成工作所需的所有文件、操作、人员和帮助。
...
- 搜索学校、最近使用的文档或搜索最常用的功能区命令
- 查找主题或主题以获取有关该主题的详细信息
