...
### <a name="powerpoint-feature-updates"></a><span data-ttu-id="c5d6f-140">PowerPoint：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-140">PowerPoint: Feature updates</span></span>
...
### <a name="powerpoint-feature-updates"></a><span data-ttu-id="c5d6f-189">PowerPoint：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-189">PowerPoint: Feature updates</span></span> 
...
### <a name="project-feature-updates"></a><span data-ttu-id="c5d6f-212">Project：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-212">Project: Feature updates</span></span> 
...
### <a name="outlook-security-updates"></a><span data-ttu-id="c5d6f-228">Outlook：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-228">Outlook: Security updates</span></span> 
...
- <span data-ttu-id="c5d6f-272">**公式编辑器转换器** 用户可以使用转换器将使用 Microsoft 公式编辑器创建的公式转换为 Office Math ML 格式以启用编辑。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-272">**Equation Editor converter** Converter allows users to convert equations created using Microsoft Equation editor to Office Math ML format to enable editing.</span></span>
...
### <a name="access-feature-updates"></a><span data-ttu-id="c5d6f-286">Access：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-286">Access: Feature Updates</span></span>
...
### <a name="outlook-non-security-updates"></a><span data-ttu-id="c5d6f-305">Outlook：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-305">Outlook: Non-security updates</span></span>
...
### <a name="outlook-security-updates"></a><span data-ttu-id="c5d6f-319">Outlook：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-319">Outlook: Security updates</span></span>
...
### <a name="visio-feature-updates"></a><span data-ttu-id="c5d6f-334">Visio：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-334">Visio: Feature updates</span></span>
...
### <a name="outlook-security-updates"></a><span data-ttu-id="c5d6f-350">Outlook：安全更新程序</span><span class="sxs-lookup"><span data-stu-id="c5d6f-350">Outlook: Security updates</span></span>
...
### <a name="powerpoint-feature-updates"></a><span data-ttu-id="c5d6f-365">PowerPoint：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-365">PowerPoint: Feature updates</span></span>
...
- <span data-ttu-id="c5d6f-394">修复了以下问题：应用程序调用 MAPI API 可能会导致故障。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-394">Fix an issue where an application calling the MAPI API could result in a crash.</span></span>
...
### <a name="outlook-feature-updates"></a><span data-ttu-id="c5d6f-409">Outlook：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-409">Outlook: Feature updates</span></span>
...
## <a name="version-1804-may-8"></a><span data-ttu-id="c5d6f-445">版本 1804：5 月 8 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-445">Version 1804: May 8</span></span>
<span data-ttu-id="c5d6f-446">*版本 1804（内部版本 9226.2126）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-446">*Version 1804 (Build 9226.2126)*</span></span>

### <a name="excel-security-updates"></a><span data-ttu-id="c5d6f-447">Excel：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-447">Excel: Security updates</span></span>
-   <span data-ttu-id="c5d6f-448">[CVE-2018-8147](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8147)：Microsoft Excel 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-448">[CVE-2018-8147](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8147): Microsoft Excel Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-449">[CVE-2018-8148](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8148)：Microsoft Excel 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-449">[CVE-2018-8148](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8148): Microsoft Excel Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-450">[CVE-2018-8162](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8162)：Microsoft Excel 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-450">[CVE-2018-8162](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8162): Microsoft Excel Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-451">[CVE-2018-8163](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8163)：Microsoft Excel 信息泄漏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-451">[CVE-2018-8163](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8163): Microsoft Excel Information Disclosure Vulnerability</span></span>

### <a name="outlook-security-updates"></a><span data-ttu-id="c5d6f-452">Outlook：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-452">Outlook: Security updates</span></span>
-   <span data-ttu-id="c5d6f-453">[CVE-2018-8150](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8150)：Microsoft Outlook 安全功能规避漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-453">[CVE-2018-8150](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8150): Microsoft Outlook Security Feature Bypass Vulnerability</span></span>

### <a name="office-suite-security-updates"></a><span data-ttu-id="c5d6f-454">Office 套件：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-454">Office suite: Security updates</span></span>
-   <span data-ttu-id="c5d6f-455">[CVE-2018-8157](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8157)：Microsoft Office 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-455">[CVE-2018-8157](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8157): Microsoft Office Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-456">[CVE-2018-8158](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8158)：Microsoft Office 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-456">[CVE-2018-8158](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-8158): Microsoft Office Remote Code Execution Vulnerability</span></span>


## <a name="version-1804-april-25"></a><span data-ttu-id="c5d6f-457">版本 1804：4 月 25 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-457">Version 1804: April 25</span></span>
<span data-ttu-id="c5d6f-458">*版本 1804（内部版本 9226.2114）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-458">*Version 1804 (Build 9226.2114)*</span></span>

### <a name="outlook-feature-updates"></a><span data-ttu-id="c5d6f-459">Outlook：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-459">Outlook: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-p163">**收听电子邮件：** Outlook 可以大声读出电子邮件，并能一边朗读一边突出显示文本。[了解详细信息](https://support.office.com/article/64e393a4-1229-45c0-acdb-dc93330ebdb3)</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p163">**Listen to your emails:** Outlook can read your email aloud, highlighting text as it's read. [Learn more](https://support.office.com/article/64e393a4-1229-45c0-acdb-dc93330ebdb3)</span></span>
-   <span data-ttu-id="c5d6f-p164">**绝不错过任何提醒：** 设置在工作窗口中弹出的提醒。如果不设置，Outlook 会在任务栏中闪烁，以引起用户注意。[了解详细信息](https://support.office.com/article/7a992377-ca93-4ddd-a711-851ef3597925)</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p164">**Never miss a reminder:** Set reminders to pop up over windows you're working in. Otherwise, Outlook will blink in the taskbar to get your attention.[Learn more](https://support.office.com/article/7a992377-ca93-4ddd-a711-851ef3597925)</span></span>
-   <span data-ttu-id="c5d6f-p165">**将已删除邮件标记为已读：** 现在可以将任何已删除邮件设置为已读。启用方法为，依次转到“文件”\>“选项”\>“邮件”\>“其他”。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p165">**Mark deleted items as read:** You can now set any message that you delete as read. Opt in by going to File \> Options \> Mail \> Other.</span></span>
-   <span data-ttu-id="c5d6f-p166">**加密选项：** Office 365 邮件加密用户可以加密邮件，并将邮件发送给组织内外的任何人。创建邮件时，可以在“选项”\>“权限”下找到加密选项。[了解详细信息](https://aka.ms/omeoverview)</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p166">**Encrypt option:** Office 365 Message Encryption users can encrypt a message and send it to anyone, inside or outside their organization. Encrypt option appears under Options \> Permissions when creating a message. [Learn more](https://aka.ms/omeoverview)</span></span>

### <a name="powerpoint-feature-updates"></a><span data-ttu-id="c5d6f-469">PowerPoint：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-469">PowerPoint: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-p167">**转换墨迹：** 获取自由曲线备注和绘图，并将它们转换为可读文本和清晰形状，以创建完善的演示文稿。[了解详细信息](https://support.office.com/article/8ca00db0-4342-4bde-bbb2-92d6cb5e2e45)</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p167">**Convert your ink:** Take scribbled notes and drawings, and convert them into readable text and crisp shapes to create a polished presentation. [Learn more](https://support.office.com/article/8ca00db0-4342-4bde-bbb2-92d6cb5e2e45)</span></span>

### <a name="project-feature-updates"></a><span data-ttu-id="c5d6f-472">Project：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-472">Project: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-473">**任务板筛选：** 通过筛选主要资源或摘要任务来简化任务板。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-473">**Task board filtering:** Streamline your task boards by filtering on key resources or summary tasks.</span></span>
-   <span data-ttu-id="c5d6f-474">**在任务板中设置完成百分比：** 为每列都选择一个完成百分比，再通过拖放操作来更新任务完成进度。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-474">**Set percent complete from a task board:** Choose a percent complete for each column, and then update task completion with drag-and-drop.</span></span>
-   <span data-ttu-id="c5d6f-475">**冲刺 (sprint) 导航：** 从一个冲刺 (sprint) 视图切换到另一个，并在两个冲刺 (sprint) 视图之间快速移动任务。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-475">**Sprint navigation:** Switch from one sprint view to another, and quickly move tasks between sprints.</span></span>

### <a name="word-feature-updates"></a><span data-ttu-id="c5d6f-476">Word：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-476">Word: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-477">**发现并修复相关校对问题：** 现在，可以在“编辑器”窗格中概览文档的校对问题，这样就能重点修复与自己最相关的问题了。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-477">**Find and fix relevant proofing issues:** Editor pane now displays an overview of proofing issues found in your document, so the focus is on fixing the ones that are most relevant to you.</span></span>


## <a name="version-1803-april-11"></a><span data-ttu-id="c5d6f-478">版本 1803：4 月 11 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-478">Version 1803: April 11</span></span>
<span data-ttu-id="c5d6f-479">*版本 1803（内部版本 9126.2152）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-479">*Version 1803 (Build 9126.2152)*</span></span>

### <a name="excel-security-updates"></a><span data-ttu-id="c5d6f-480">Excel：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-480">Excel: Security updates</span></span>
-   <span data-ttu-id="c5d6f-481">[CVE-2018-1029](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-1029)：Microsoft Excel 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-481">[CVE-2018-1029](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-1029): Microsoft Excel Remote Code Execution Vulnerability</span></span>

### <a name="powerpoint-non-security-updates"></a><span data-ttu-id="c5d6f-482">PowerPoint：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-482">PowerPoint: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-483">修复了以下问题：多个用户在同一个演示文稿中共同创作导致幻灯片母板复制不正确。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-483">Fix an issue where multiple users co-authoring on the same presentation results in an incorrect duplication of slides masters.</span></span>
-   <span data-ttu-id="c5d6f-484">修复了以下问题：打开保存在 OneDrive 上的文件导致 PowerPoint 在退出受保护的视图时出现故障。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-484">Fix an issue where opening a file saved on OneDrive results in PowerPoint crashing when exiting Protected View.</span></span>

### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="c5d6f-485">Skype for Business：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-485">Skype for Business: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-486">修复了与 TLS 1.2 支持相关的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-486">Fix an issue related to TLS 1.2 support.</span></span>

### <a name="word-non-security-updates"></a><span data-ttu-id="c5d6f-487">Word：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-487">Word: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-488">修复了导致出现内存不足消息的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-488">Fix an issue that causes an insufficient memory message to appear.</span></span>

### <a name="office-suite-security-updates"></a><span data-ttu-id="c5d6f-489">Office 套件：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-489">Office suite: Security updates</span></span>
-   <span data-ttu-id="c5d6f-490">[CVE-2018-0950](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0950)：Microsoft Office 信息泄漏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-490">[CVE-2018-0950](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0950): Microsoft Office Information Disclosure Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-491">[CVE-2018-1026](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-1026)：Microsoft Office 远程执行代码漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-491">[CVE-2018-1026](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-1026): Microsoft Office Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-492">[CVE-2018-1030](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-1030)：Microsoft Office 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-492">[CVE-2018-1030](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-1030): Microsoft Office Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-p168">
  \*\*出于安全考虑，禁止在 Office 中激活 Flash、Silverlight 和 Shockwave 控件：\*\* 出于安全考虑，Windows 上的 Microsoft Office for Office 365 新版本阻止激活 Flash、Silverlight 和 Shockwave 控件。可通过[此处](https://techcommunity.microsoft.com/t5/Security-Privacy-and-Compliance/Blocking-Flash-Shockwave-Silverlight-controls-from-activating-in/ba-p/191729)和[此处](https://support.office.com/en-us/article/flash-silverlight-and-shockwave-controls-blocked-in-office-2016-55738f12-a01d-420e-a533-7cef1ff6aeb1?ui=en-US&rs=en-US&ad=US)了解详细信息。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p168">**Flash, Silverlight and Shockwave controls blocked from activating in Office for security reasons:** For security reasons new builds of Microsoft Office for Office 365 on Windows block activation of Flash, Silverlight, and Shockwave controls.  Learn more [here](https://techcommunity.microsoft.com/t5/Security-Privacy-and-Compliance/Blocking-Flash-Shockwave-Silverlight-controls-from-activating-in/ba-p/191729) and [here](https://support.office.com/en-us/article/flash-silverlight-and-shockwave-controls-blocked-in-office-2016-55738f12-a01d-420e-a533-7cef1ff6aeb1?ui=en-US&rs=en-US&ad=US).</span></span>

## <a name="version-1803-march-27"></a><span data-ttu-id="c5d6f-495">版本 1803：3 月 27 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-495">Version 1803: March 27</span></span>
<span data-ttu-id="c5d6f-496">*版本 1803（内部版本 9126.2116）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-496">*Version 1803 (Build 9126.2116)*</span></span>

### <a name="excel-feature-updates"></a><span data-ttu-id="c5d6f-497">Excel：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-497">Excel: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-p169">**Microsoft Translator：** 使用 Microsoft Translator 将字词、短语或句子翻译成其他语言。可以在功能区的“审阅”选项卡中执行此操作。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p169">**Microsoft Translator:** Translate words, phrases or sentences to another language with Microsoft Translator. You can do this from the Review tab in the ribbon.</span></span>

### <a name="excel-non-security-updates"></a><span data-ttu-id="c5d6f-500">Excel：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-500">Excel: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-501">修复了以下问题：无法快速打印附加到 Outlook 电子邮件的 Excel 工作簿。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-501">Fix an issue where Quick Print of an Excel workbook attached to an Outlook email may not print.</span></span>
-   <span data-ttu-id="c5d6f-502">修复了以下问题：单击超链接可能会导致 Excel 发生故障。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-502">Fix an issue where clicking on a hyperlink may cause Excel to crash.</span></span>
-   <span data-ttu-id="c5d6f-503">修复了以下问题：使用多维数据集函数导致 Excel 发生故障。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-503">Fix an issue where using cube functions causes Excel to crash.</span></span>

### <a name="onedrive-for-business-non-security-updates"></a><span data-ttu-id="c5d6f-504">OneDrive for Business：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-504">OneDrive for Business: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-505">修复了以下问题：OneDrive for Business (Groove.exe) 在任务管理器中长时间使用 CPU 的一个 CPU 内核资源（例如，4 核 CPU 的 25%）。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-505">Fix an issue where OneDrive for Business (Groove.exe) consumes one CPU core’s worth of CPU (for example, 25% on a 4 core CPU) in Task Manager for extended periods of time.</span></span>

### <a name="outlook-feature-updates"></a><span data-ttu-id="c5d6f-506">Outlook：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-506">Outlook: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-507">**密件抄送 (Bcc) 警告：** 如果对之前密件抄送的邮件选择“全部答复”，将显示警告。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-507">**Blind carbon copy (Bcc) warning:** A warning appears if you choose Reply All to a message that you were Bcc’ed on.</span></span>
-   <span data-ttu-id="c5d6f-p170">**更智能的“收件人:”行：** 在单击“收件人:”行处理邮件时，会提示用户可能要选择的收件人。此外，还可以看到收件人的照片，这样用户便知道将要向其发送邮件的收件人正确无误。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p170">**A smarter To: line:** When you click the To: line to address a message, we suggest recipients you're likely to choose. Plus, you can see their picture, so you know yo’re sending to the right person.</span></span> 

### <a name="powerpoint-feature-updates"></a><span data-ttu-id="c5d6f-510">PowerPoint：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-510">PowerPoint: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-p171">**Microsoft Translator：** 使用 Microsoft Translator 将字词、短语或句子翻译成其他语言。可以在功能区的“审阅”选项卡中执行此操作。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p171">**Microsoft Translator:** Translate words, phrases or sentences to another language with Microsoft Translator. You can do this from the Review tab in the ribbon.</span></span>
-   <span data-ttu-id="c5d6f-p172">**增强了对高清晰度显示器的支持**：现在，如果用户使用多个显示器或笔记本电脑基座配件，Office 应用在每个显示器上都会有清晰画面，即使显示器有不同的缩放设置也是如此。 [了解更多](https://support.office.com/article/6720ca0e-be59-41f6-b629-1369f549279d)</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p172">**Improved support for high definition displays**: If you use multiple monitors or a laptop dock, Office apps will now look crisp on every display, even if the displays have different scaling settings. [Learn more](https://support.office.com/article/6720ca0e-be59-41f6-b629-1369f549279d)</span></span>

### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="c5d6f-515">Skype for Business：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-515">Skype for Business: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-516">修复了在会议中通过选择“Skype 通话”来添加用户导致出错的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-516">Fix an issue where adding users by selecting 'Skype Call' in a meeting causes an error.</span></span>
-   <span data-ttu-id="c5d6f-517">如果 Skype 会议室已被添加为位置且会议已包含 Teams 会议协调人，则删除要求用户向会议添加 Skype 协调人的提示。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-517">Remove prompt asking user to add Skype coordinates to a meeting, if a Skype Room is added as the location and the meeting already contains Teams meeting coordinates.</span></span>

### <a name="visio-feature-updates"></a><span data-ttu-id="c5d6f-518">Visio：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-518">Visio: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-p173">**增强了对高清晰度显示器的支持**：现在，如果用户使用多个显示器或笔记本电脑基座配件，Office 应用在每个显示器上都会有清晰画面，即使显示器有不同的缩放设置也是如此。 [了解更多](https://support.office.com/article/6720ca0e-be59-41f6-b629-1369f549279d)</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p173">**Improved support for high definition displays**: If you use multiple monitors or a laptop dock, Office apps will now look crisp on every display, even if the displays have different scaling settings. [Learn more](https://support.office.com/article/6720ca0e-be59-41f6-b629-1369f549279d)</span></span>

### <a name="word-feature-updates"></a><span data-ttu-id="c5d6f-521">Word：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-521">Word: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-p174">**增强了对高清晰度显示器的支持**：现在，如果用户使用多个显示器或笔记本电脑基座配件，Office 应用在每个显示器上都会有清晰画面，即使显示器有不同的缩放设置也是如此。 [了解更多](https://support.office.com/article/6720ca0e-be59-41f6-b629-1369f549279d)</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p174">**Improved support for high definition displays**: If you use multiple monitors or a laptop dock, Office apps will now look crisp on every display, even if the displays have different scaling settings. [Learn more](https://support.office.com/article/6720ca0e-be59-41f6-b629-1369f549279d)</span></span>


## <a name="version-1802-march-13"></a><span data-ttu-id="c5d6f-524">版本 1802：3 月 13 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-524">Version 1802: March 13</span></span>
<span data-ttu-id="c5d6f-525">*版本 1802（内部版本 9029.2253）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-525">*Version 1802 (Build 9029.2253)*</span></span>

### <a name="access-security-updates"></a><span data-ttu-id="c5d6f-526">Access：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-526">Access: Security updates</span></span>
-   <span data-ttu-id="c5d6f-527">[CVE-2018-0903](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0903)：Microsoft Access 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-527">[CVE-2018-0903](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0903): Microsoft Access Remote Code Execution Vulnerability</span></span>

### <a name="excel-security-updates"></a><span data-ttu-id="c5d6f-528">Excel：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-528">Excel: Security updates</span></span>
-   <span data-ttu-id="c5d6f-529">[CVE-2018-0907](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0907)：Microsoft Office Excel 安全功能规避漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-529">[CVE-2018-0907](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0907): Microsoft Office Excel Security Feature Bypass</span></span>

### <a name="word-security-updates"></a><span data-ttu-id="c5d6f-530">Word：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-530">Word: Security updates</span></span>
-   <span data-ttu-id="c5d6f-531">[CVE-2018-0919](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0919)：Microsoft Office 信息泄漏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-531">[CVE-2018-0919](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0919): Microsoft Office Information Disclosure Vulnerability</span></span>


## <a name="version-1802-february-26"></a><span data-ttu-id="c5d6f-532">版本 1802：2 月 26 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-532">Version 1802: February 26</span></span>
<span data-ttu-id="c5d6f-533">*版本 1802（内部版本 9029.2167）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-533">*Version 1802 (Build 9029.2167)*</span></span>

### <a name="outlook-feature-updates"></a><span data-ttu-id="c5d6f-534">Outlook：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-534">Outlook: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-535">**知道将与谁一起开会：** 即使你不是组织者，现在也可以看到其他人对会议请求的响应。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-535">**Know who you'll be meeting with:** You can see other people's responses to a meeting request, even if you aren't the organizer.</span></span>
-   <span data-ttu-id="c5d6f-536">**轻松排序电子邮件：** 感谢提供反馈，我们已为未使用重点收件箱的用户，在邮件列表和未读邮件筛选器上方恢复了排序功能。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-536">**Sort your email with ease:** Thanks to your feedback, we've brought back sorting above the message list and the Unread filter for people who don't use Focused Inbox.</span></span>

### <a name="project-non-security-updates"></a><span data-ttu-id="c5d6f-537">Project：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-537">Project: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-538">修复了以下问题：在会话中设置多个基线会将 MOD\_DATE 值设为相同的值。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-538">Fix an issue where setting more than one baseline in a session sets the MOD\_DATE value as the same.</span></span>

### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="c5d6f-539">Skype for Business：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-539">Skype for Business: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-540">修复了以下问题：即使将 UseLocationForE911Only 设置为 true，位置也会被填充。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-540">Fix an issue where location is populated even when UseLocationForE911Only is set to true.</span></span>
-   <span data-ttu-id="c5d6f-541">修复了以下问题：通过“使用会议中心呼叫”选项邀请名单中的用户时，Skype for Business 挂起。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-541">Fix an issue where Skype for Business hangs when using the "call using conference center" option to invite users from the roster.</span></span>
-   <span data-ttu-id="c5d6f-542">修复了以下问题：创建 Skype for Business 会议期间，终端服务器上运行的 Outlook 冻结。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-542">Fix an issue where Outlook running on terminal server freezes while creating a Skype for Business meeting.</span></span>
-   <span data-ttu-id="c5d6f-543">将 EnableRestoreOAuthUsedKeyWhenUsingCachedWebTicket 的默认值更改为 TRUE。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-543">Change the default value of EnableRestoreOAuthUsedKeyWhenUsingCachedWebTicket to TRUE.</span></span>

### <a name="visio-feature-updates"></a><span data-ttu-id="c5d6f-544">Visio：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-544">Visio: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-p175">**内置数据库模型图：** 使用新增的数据库模型图模板，可以将数据库准确建模为 Visio 图。不需要加载项。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p175">**Built-in database model diagrams:** Use the new Database Model Diagram template to accurately model your database as a Visio diagram. No add-in required.</span></span>
-   <span data-ttu-id="c5d6f-547">**更多适用于业务图表的模具：** 使用新式形状，通过维恩图比较和对比数据，或绘制循环图、矩阵图或棱锥图来帮助传达信息。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-547">**More stencils for business diagrams:** Using modern shapes, compare and contrast data with a Venn diagram, or draw Cycle, Matrix, or Pyramid diagrams to help tell your story.</span></span>
-   <span data-ttu-id="c5d6f-548">**保持图表和源同步：** 在 Visio 中编辑数据可视化工具图表时，可以视需要根据最新图表内容，更新链接的 Excel 源数据。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-548">**Keep your diagram and source in sync:** When you edit a Data Visualizer diagram in Visio, you have the option to update the linked Excel source data with the latest diagram content.</span></span>


## <a name="version-1801-february-13"></a><span data-ttu-id="c5d6f-549">版本 1801：2 月 13 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-549">Version 1801: February 13</span></span>
<span data-ttu-id="c5d6f-550">*版本 1801（内部版本 9001.2171）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-550">*Version 1801 (Build 9001.2171)*</span></span>

### <a name="excel-security-updates"></a><span data-ttu-id="c5d6f-551">Excel：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-551">Excel: Security updates</span></span>
-   <span data-ttu-id="c5d6f-552">[CVE-2018-0841](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0841)：Microsoft Excel 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-552">[CVE-2018-0841](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0841): Microsoft Excel Remote Code Execution Vulnerability</span></span>

### <a name="outlook-security-updates"></a><span data-ttu-id="c5d6f-553">Outlook：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-553">Outlook: Security updates</span></span>
-   <span data-ttu-id="c5d6f-554">[CVE-2018-0850](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0850)：Microsoft Outlook 特权提升漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-554">[CVE-2018-0850](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0850): Microsoft Outlook Elevation of Privilege Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-555">[CVE-2018-0852](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0852)：Microsoft Outlook 内存损坏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-555">[CVE-2018-0852](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0852): Microsoft Outlook Memory Corruption Vulnerability</span></span>

### <a name="office-suite-security-updates"></a><span data-ttu-id="c5d6f-556">Office 套件：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-556">Office suite: Security updates</span></span>
-   <span data-ttu-id="c5d6f-557">[CVE-2018-0851](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0851)：Microsoft Office 内存损坏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-557">[CVE-2018-0851](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0851): Microsoft Office Memory Corruption Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-558">[CVE-2018-0853](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0853)：Microsoft Office 信息泄漏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-558">[CVE-2018-0853](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0853): Microsoft Office Information Disclosure Vulnerability</span></span>


## <a name="version-1801-february-7"></a><span data-ttu-id="c5d6f-559">版本 1801：2 月 7 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-559">Version 1801: February 7</span></span>
<span data-ttu-id="c5d6f-560">*版本 1801（内部版本 9001.2144）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-560">*Version 1801 (Build 9001.2144)*</span></span>

### <a name="excel-non-security-updates"></a><span data-ttu-id="c5d6f-561">Excel：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-561">Excel: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-562">修复了以下问题：如果编辑语言是日语、中文或韩语，那么尝试在“开始”选项卡上选择新字体或进行编辑时，Excel 可能会冻结。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-562">Fix an issue where, if your editing language is Japanese, Chinese, or Korean, Excel may freeze when you try to choose a new font on the Home tab or when you edit.</span></span>


## <a name="version-1801-february-1"></a><span data-ttu-id="c5d6f-563">版本 1801：2 月 1 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-563">Version 1801: February 1</span></span>
<span data-ttu-id="c5d6f-564">*版本 1801（内部版本 9001.2138）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-564">*Version 1801 (Build 9001.2138)*</span></span>

### <a name="project-non-security-updates"></a><span data-ttu-id="c5d6f-565">Project：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-565">Project: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-566">修复了以下问题：在“​​保存以共享”会话中删除“实际工时”后，它仍显示在报表中。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-566">Fix an issue where Actual Work is still shown in the reporting tables after being removed in a Save for Sharing session.</span></span>
-   <span data-ttu-id="c5d6f-567">修复了进行日程安排时在德语版本中使用“星期”日期格式返回错误的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-567">Fix an issue in the German language version where using a Weeks date format returns an error when scheduling.</span></span>
-   <span data-ttu-id="c5d6f-568">修复了在日程安排 Web 部件中编辑完成日期时任务每天停留 8 小时而不随着时间推移的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-568">Fix an issue where, when editing finish dates in Schedule Web Part, tasks stay at 8 hours per day instead of being spread over time.</span></span>
-   <span data-ttu-id="c5d6f-569">修复了在意外的位置绘制“进度点形状”的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-569">Fix an issue where "Progress point shape" is drawn at an unexpected location.</span></span>

### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="c5d6f-570">Skype for Business：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-570">Skype for Business: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-571">修复了以下问题：当会议处于全屏模式时，“更多选项”和“邀请更多人”按钮隐藏。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-571">Fix an issue where "More Options" and "Invite More People" buttons are hidden when a meeting is in full-screen mode.</span></span>
-   <span data-ttu-id="c5d6f-572">修复了尝试加入时 P2P 音频呼叫窗口或电话会议窗口变成透明的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-572">Fix an issue where the P2P audio call window or conference call window becomes transparent when you attempt to join.</span></span>
-   <span data-ttu-id="c5d6f-573">修复了即将开始的 Skype 会议不出现在“会议”选项卡中的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-573">Fix an issue where upcoming Skype meetings do not show up in the meetings tab.</span></span>
-   <span data-ttu-id="c5d6f-574">修复了在没有音频的情况下配置 Skype for Business 以加入会议时，添加音频到会议会对用户本人启动一个新的 P2P 呼叫，而不是添加音频到现有会议的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-574">Fix an issue where, when Skype for Business is configured to join meetings without audio, adding audio to a meeting initiates a new P2P call to the user itself rather than adding audio to the existing meeting.</span></span>
-   <span data-ttu-id="c5d6f-575">修复了以下问题：在 Outlook 中单击会议请求内的“加入 Skype 会议”链接时，用户看到“找不到此 Skype 会议”错误消息。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-575">Fix an issue where user receives the error message "We couldn't find this Skype meeting" when clicking 'Join Skype Meeting' link in a meeting request from Outlook.</span></span>


## <a name="version-1712-january-30"></a><span data-ttu-id="c5d6f-576">版本 1712：1 月 30 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-576">Version 1712: January 30</span></span>
<span data-ttu-id="c5d6f-577">*版本 1712（内部版本 8827.2179）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-577">*Version 1712 (Build 8827.2179)*</span></span>

### <a name="excel-non-security-updates"></a><span data-ttu-id="c5d6f-578">Excel：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-578">Excel: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-579">修复了最小化 Excel 时打开工作簿后滚动条缺失的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-579">Fix and issue where the scroll bars are missing when a workbook is opened when Excel is minimized.</span></span>

### <a name="outlook-non-security-updates"></a><span data-ttu-id="c5d6f-580">Outlook：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-580">Outlook: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-581">修复了以下问题：在搜索范围为全部邮箱时，搜索失败且看到“找不到匹配”错误消息。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-581">Fix an issue where search fails with “No matches found” when search is scoped to All Mailboxes.</span></span>


## <a name="version-1712-january-17"></a><span data-ttu-id="c5d6f-582">版本 1712：1 月 17 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-582">Version 1712: January 17</span></span>
<span data-ttu-id="c5d6f-583">*版本 1712（内部版本 8827.2148）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-583">*Version 1712 (Build 8827.2148)*</span></span>

### <a name="excel-feature-updates"></a><span data-ttu-id="c5d6f-584">Excel：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-584">Excel: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-585">**将 SVG 图标转换为形状：** 将所有 SVG 图片和图标都转换为 Office 形状，这样就可以更改它们的颜色、尺寸或纹理。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-585">**Convert SVG icons to shapes:** Transform all SVG pictures and icons into Office shapes so you can change their color, size, or texture.</span></span>
-   <span data-ttu-id="c5d6f-586">**取消选中单元格：** 在工作表中进行选择，并取消选中不小心单击的单元格，而不必重新开始。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-586">**Deselect cells:** Make selections in your worksheet and deselect cells that you accidentally clicked without having to start over.</span></span>

### <a name="excel-non-security-updates"></a><span data-ttu-id="c5d6f-587">Excel：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-587">Excel: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-588">修复了以下问题：在文件资源管理器中双击文件名打开多个工作簿时，工作簿引用失败。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-588">Fix an issue where workbook references fail when opening multiple workbooks by double-clicking on the file names in File Explorer.</span></span>

### <a name="outlook-feature-updates"></a><span data-ttu-id="c5d6f-589">Outlook：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-589">Outlook: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-590">**将 SVG 图标转换为形状：** 将所有 SVG 图片和图标都转换为 Office 形状，这样就可以更改它们的颜色、尺寸或纹理。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-590">**Convert SVG icons to shapes:** Transform all SVG pictures and icons into Office shapes so you can change their color, size, or texture.</span></span>
-   <span data-ttu-id="c5d6f-591">**Office 365 群组的改进：** 阅读和回复群组对话比以往更加简便，因为你可以双击群组消息在其自己的窗口中打开。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-591">**Improvements to Office 365 groups:** It’s easier than ever to read and reply to group conversations because you can double-click on a group message to open it in its own window.</span></span>

### <a name="powerpoint-feature-updates"></a><span data-ttu-id="c5d6f-592">PowerPoint：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-592">PowerPoint: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-593">**3D 动画：** 通过添加轻轻摇摆、跳跃和旋转等动画效果，让你的 3D 模型活起来。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-593">**3D animations:** Bring your 3D models to life with animations such as swinging gently or jumping and turning.</span></span>
-   <span data-ttu-id="c5d6f-594">**将 SVG 图标转换为形状：** 将所有 SVG 图片和图标都转换为 Office 形状，以便可更改其颜色、大小或纹理。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-594">**Convert SVG icons to shapes:** Transform all SVG pictures and icons into Office shapes so you can change their color, size, or texture.</span></span>

### <a name="skype-for-business-non-security-updates"></a><span data-ttu-id="c5d6f-595">Skype for Business：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-595">Skype for Business: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-596">在用于传入 PSTN 呼叫的 Toast UI 中添加呼叫转移按钮。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-596">Add call transfer button in the toast UI for incoming PSTN calls.</span></span>
-   <span data-ttu-id="c5d6f-597">当 ChatDefaultClient 和 CallDefaultClient 设置为“团队”时，通知用户呼叫和聊天正在发送到“团队”。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-597">Notify users that calls and chat are being sent to Teams when ChatDefaultClient and CallDefaultClient are set to Teams.</span></span>
-   <span data-ttu-id="c5d6f-598">当用户不在会议中时，显示用户为“脱机”状态，并禁用 Skype for Business，同时会议加入体验设置为“本地有限客户端”。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-598">Show user’s presence as Offline when user is not in a meeting and disabled from Skype for Business and meeting join experience is set to Native Limited Client.</span></span>
-   <span data-ttu-id="c5d6f-599">当 Skype for Business 最小化到通知区域时，禁用除“打开”和“退出”之外的所有选项。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-599">Disable all options except Open and Exit when Skype for Business is minimized to the notification area.</span></span> 
-   <span data-ttu-id="c5d6f-600">当启用与 Aries 手机和 RedirectClient 配对时，禁止新的呼叫和对话。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-600">Suppress new calls and conversations when paired with Aries phones and RedirectClient is enabled.</span></span>
-   <span data-ttu-id="c5d6f-601">修复了日期格式不是美国格式 (mm/dd/yy) 时，按日期在 PChat 中搜索消息失败的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-601">Fix an issue where searching messages in PChat by date fails when the date format is other than US format (mm/dd/yy).</span></span>
-   <span data-ttu-id="c5d6f-602">修复了 EnableExternalP2PFileTransfer 策略设置为 false 时，用户仍然能够在会议中附加文件的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-602">Fix an issue where, when EnableExternalP2PFileTransfer policy is set to false, users are still able to attach files in meetings.</span></span>

### <a name="visio-feature-updates"></a><span data-ttu-id="c5d6f-603">Visio：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-603">Visio: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-p176">**使用 Excel 模板导出到 Visio 关系图：** 跳转到 Visio 流程图。在其中一个流程图 Excel 模板中输入数据并导出到 Visio，以自动创建关系图。需要安装 Visio Pro for Office 365。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-p176">**Use Excel templates to export to a Visio diagram:** Get a jump on your Visio flowcharts. Enter your data in one of the Process Map Excel templates and export to Visio to create the diagram automatically. Requires Visio Pro for Office 365.</span></span>

### <a name="word-feature-updates"></a><span data-ttu-id="c5d6f-607">Word：功能更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-607">Word: Feature updates</span></span>
-   <span data-ttu-id="c5d6f-608">**将 SVG 图标转换为形状：** 将所有 SVG 图片和图标都转换为 Office 形状，这样就可以更改它们的颜色、尺寸或纹理。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-608">**Convert SVG icons to shapes:** Transform all SVG pictures and icons into Office shapes so you can change their color, size, or texture.</span></span>


## <a name="version-1711-january-9"></a><span data-ttu-id="c5d6f-609">版本 1711：1 月 9 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-609">Version 1711: January 9</span></span>
<span data-ttu-id="c5d6f-610">*版本 1711（内部版本 8730.2175）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-610">*Version 1711 (Build 8730.2175)*</span></span>

### <a name="excel-security-updates"></a><span data-ttu-id="c5d6f-611">Excel：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-611">Excel: Security updates</span></span>
-   <span data-ttu-id="c5d6f-612">[CVE-2018-0796](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0796)：Microsoft Excel 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-612">[CVE-2018-0796](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0796): Microsoft Excel Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-613">[公告 170021](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/ADV170021)：Microsoft Office 深度防御更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-613">[Advisory 170021](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/ADV170021): Microsoft Office Defense in Depth Update</span></span>

### <a name="outlook-security-updates"></a><span data-ttu-id="c5d6f-614">Outlook：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-614">Outlook: Security updates</span></span>
-   <span data-ttu-id="c5d6f-615">[CVE-2018-0791](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0791)：Microsoft Outlook 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-615">[CVE-2018-0791](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0791): Microsoft Outlook Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-616">[CVE-2018-0793](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0793)：Microsoft Outlook 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-616">[CVE-2018-0793](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0793): Microsoft Outlook Remote Code Execution Vulnerability</span></span>

### <a name="word-security-updates"></a><span data-ttu-id="c5d6f-617">Word：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-617">Word: Security updates</span></span>
-   <span data-ttu-id="c5d6f-618">[CVE-2018-0792](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0792)：Microsoft Word 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-618">[CVE-2018-0792](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0792): Microsoft Word Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-619">[CVE-2018-0793](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0793)：Microsoft Outlook 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-619">[CVE-2018-0793](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0793): Microsoft Outlook Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-620">[CVE-2018-0794](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0794)：Microsoft Word 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-620">[CVE-2018-0794](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0794): Microsoft Word Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-621">[CVE-2018-0798](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0798)：Microsoft Office 内存损坏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-621">[CVE-2018-0798](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0798): Microsoft Office Memory Corruption Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-622">[CVE-2018-0801](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0801)：Microsoft Office 远程执行代码漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-622">[CVE-2018-0801](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0801): Microsoft Office Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-623">[CVE-2018-0802](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0802)：Microsoft Office 内存损坏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-623">[CVE-2018-0802](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0802): Microsoft Office Memory Corruption Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-624">[CVE-2018-0804](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0804)：Microsoft Word 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-624">[CVE-2018-0804](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0804): Microsoft Word Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-625">[CVE-2018-0805](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0805)：Microsoft Word 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-625">[CVE-2018-0805](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0805): Microsoft Word Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-626">[CVE-2018-0806](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0806)：Microsoft Word 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-626">[CVE-2018-0806](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0806): Microsoft Word Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-627">[CVE-2018-0807](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0807)：Microsoft Word 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-627">[CVE-2018-0807](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0807): Microsoft Word Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-628">[CVE-2018-0812](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0812)：Microsoft Word 内存损坏漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-628">[CVE-2018-0812](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0812): Microsoft Word Memory Corruption Vulnerability</span></span>

### <a name="office-suite-security-updates"></a><span data-ttu-id="c5d6f-629">Office 套件：安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-629">Office suite: Security updates</span></span>
-   <span data-ttu-id="c5d6f-630">[CVE-2018-0795](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0795)：Microsoft Office 远程代码执行漏洞</span><span class="sxs-lookup"><span data-stu-id="c5d6f-630">[CVE-2018-0795](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/CVE-2018-0795): Microsoft Office Remote Code Execution Vulnerability</span></span>
-   <span data-ttu-id="c5d6f-631">[公告 180003](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/ADV180003)：Microsoft Office 深度防御更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-631">[Advisory 180003](https://portal.msrc.microsoft.com/zh-CN/security-guidance/advisory/ADV180003): Microsoft Office Defense in Depth Update</span></span>


## <a name="version-1711-january-2"></a><span data-ttu-id="c5d6f-632">版本 1711：1 月 2 日</span><span class="sxs-lookup"><span data-stu-id="c5d6f-632">Version 1711: January 2</span></span>
<span data-ttu-id="c5d6f-633">*版本 1711（内部版本 8730.2165）*</span><span class="sxs-lookup"><span data-stu-id="c5d6f-633">*Version 1711 (Build 8730.2165)*</span></span>

### <a name="excel-non-security-updates"></a><span data-ttu-id="c5d6f-634">Excel：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-634">Excel: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-635">修复了在编程创建数据透视表后，编程刷新导致 Excel 崩溃的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-635">Fix an issue where the programmatic creation of a PivotTable followed by a programmatic refresh causes Excel to crash.</span></span>
-   <span data-ttu-id="c5d6f-636">修复了以编程方式调用 Workbook.Open() 可能导致 Excel 崩溃的问题。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-636">Fix an issue where programmatically calling Workbook.Open() may cause Excel to crash.</span></span>

### <a name="powerpoint-non-security-updates"></a><span data-ttu-id="c5d6f-637">PowerPoint：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-637">PowerPoint: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-638">修复了以下问题：删除文档属性和个人信息导致无法保存到 SharePoint。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-638">Fix an issue where removing document properties and personal information causes saving to SharePoint to fail.</span></span>

### <a name="project-non-security-updates"></a><span data-ttu-id="c5d6f-639">Project：非安全更新</span><span class="sxs-lookup"><span data-stu-id="c5d6f-639">Project: Non-security updates</span></span>
-   <span data-ttu-id="c5d6f-640">修复了以下问题：VBA 代码从项目中丢失。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-640">Fix an issue where VBA code gets lost from projects.</span></span>

> [!NOTE]
> <span data-ttu-id="c5d6f-641">如果在使用 Office 时遇到问题且需要帮助，建议在 [Microsoft 问答论坛](https://answers.microsoft.com/)或[技术社区](https://techcommunity.microsoft.com/)上发布问题，也可以联系[支持部门](https://support.microsoft.com/contactus)。</span><span class="sxs-lookup"><span data-stu-id="c5d6f-641">If you need help with an issue with using Office, we recommend that you post your question on [Microsoft's Answers forum](https://answers.microsoft.com/) or [Tech Community](https://techcommunity.microsoft.com/), or you can contact [support](https://support.microsoft.com/contactus).</span></span>